    ...
    select_service_button_class: ->
        page_office =
            Docs.findOne
                ...
                type:'office'
        if @slug in page_office.services then 'active blue' else ''
...
Template.office_sla.helpers
    ...
    select_ticket_type_button_class: -> if Session.equals('ticket_type_selection', @slug) then 'active blue' else ''
