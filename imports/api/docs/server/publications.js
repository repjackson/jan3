...
ReactiveTable.publish('users', Meteor.users, '', {
  disablePageCountReactivity: true
});

ReactiveTable.publish('customers', Docs, {
  type: 'customer'
}, {
  disablePageCountReactivity: true
});

ReactiveTable.publish('events', Docs, {
  type: 'event'
}, {
  disablePageCountReactivity: false
});

ReactiveTable.publish('franchisees', Docs, {
  type: 'franchisee'
}, {
  disablePageCountReactivity: true
});

ReactiveTable.publish('incidents', Docs, {
  type: 'incident'
}, {
  disablePageCountReactivity: true
});

ReactiveTable.publish('offices', Docs, {
  type: 'office'
}, {
  disablePageCountReactivity: true
});

ReactiveTable.publish('special_services', Docs, {
  type: 'special_service'
}, {
  disablePageCountReactivity: true
});

ReactiveTable.publish('jpids', Docs, {
  type: 'jpid'
}, {
  disablePageCountReactivity: true
});

ReactiveTable.publish('search_history_docs', Docs, {
  type: 'search_history_doc'
}, {
  disablePageCountReactivity: true
});

ReactiveTable.publish('office_employees', function(input) {
